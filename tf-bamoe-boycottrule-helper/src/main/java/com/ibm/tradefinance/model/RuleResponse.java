...
//without highlight and without advisory
	...
	public String toString() {
		return "RuleResponse [ruleResults=" + ruleResults + ", charges=" + charges + ", chargeAccount=" + chargeAccount
				+ "]";
	}

   public void addRuleResult(RuleResult ruleResult) {
    LoggerUtil.logRuleExecution(
        ruleResult.getName(),
        ruleResult.getStatus(),
        ruleResult.getValidationMessage(),
        ruleResult.getReferenceData()
    );
    ruleResults.add(ruleResult);
}
