 ...
 */
package http_58_47_47www_46ibm_46com_47dmn_47lifeinsurance;
...
@Path("/LifeInsuranceEligibility")
public class LifeInsuranceEligibilityResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("http://www.ibm.com/dmn/lifeinsurance", "LifeInsuranceEligibility");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("http://www.ibm.com/dmn/lifeinsurance", "LifeInsuranceEligibility", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("LifeInsuranceEligibility") + ".dmn_nologic")));
    }
