...
public class RuleResult {
	...
	@JsonProperty("advisioryStatus")
	private boolean advisioryStatus;
	...
	public RuleResult(String name, String status, String validationMessage,
			String referenceData, List<String> highLightedTexts, boolean advisioryStatus) {
		super();
		this.name = name;
		this.status = status;
		this.validationMessage = validationMessage;
		this.advisioryStatus = advisioryStatus;
		this.referenceData = referenceData;
		this.highLightedTexts = highLightedTexts;
	}
	...
	public RuleResult(String name, String status, String validationMessage,
			String referenceData, boolean advisioryStatus) {
		super();
		this.name = name;
		this.status = status;
		this.validationMessage = validationMessage;
	...
	public String toString() {
		return "RuleResult [name=" + name + ", status=" + status + ", validationMessage=" + validationMessage
				+ ", advisioryStatus=" + advisioryStatus + ", referenceData=" + referenceData + ", highLightedTexts="
				+ highLightedTexts + "]";
	}
